...
class EstacionamientosForm(forms.ModelForm):
    ...
    capacidad = forms.IntegerField(help_text="Capacidad del estacionamiento:", required=False)
    tarifa = forms.DecimalField(help_text="Tarifa del estacionamiento:",max_digits=7, decimal_places=2, required=False)
